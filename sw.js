      ...
      fetch(e.request).then(function(res) {
        ...
        return caches.match(e.request).then(function(cached) {
          ...
          return caches.match('Index.html').then(function(home) {
            return home || new Response('<!doctype html><meta charset="utf-8"><title>FALASTEEN Offline</title><body style="background:#0e0e0e;color:#e5e2e1;font-family:Arial;padding:24px"><h1>Offline</h1><p>ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ³ÃÂÃÂ®ÃÂÃÂ© ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂ®ÃÂÃÂ²ÃÂÃÂÃÂÃÂ© ÃÂÃÂºÃÂÃÂÃÂÃÂ± ÃÂÃÂÃÂÃÂªÃÂÃÂ§ÃÂÃÂ­ÃÂÃÂ©. ÃÂÃÂ£ÃÂÃÂ¹ÃÂÃÂ¯ ÃÂÃÂ§ÃÂÃÂÃÂÃÂªÃÂÃÂ­ÃÂÃÂÃÂÃÂÃÂÃÂ ÃÂÃÂ¹ÃÂÃÂÃÂÃÂ¯ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ§ÃÂÃÂªÃÂÃÂµÃÂÃÂ§ÃÂÃÂ ÃÂÃÂ£ÃÂÃÂ ÃÂÃÂ§ÃÂÃÂÃÂÃÂ³ÃÂÃÂ­ cache ÃÂÃÂ§ÃÂÃÂÃÂÃÂÃÂÃÂªÃÂÃÂµÃÂÃÂÃÂÃÂ­.</p></body>', {
              status: 503,
